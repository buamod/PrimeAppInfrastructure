...
A Terraform module which creates Application and Network Load Balancer resources on AWS.
...
module "alb" {
  ...
  target_groups = [
    {
      name_prefix      = "${var.app1}-"
      backend_protocol = var.app1_protocol
      backend_port     = var.app1_port
      target_type      = "ip"
    },
    {
      name_prefix      = "${var.app2}-"
      backend_protocol = var.app2_protocol
      backend_port     = var.app2_port
      target_type      = "ip"
    },
    {
      name_prefix      = "${var.app3}-"
      backend_protocol = var.app3_protocol
      backend_port     = var.app3_port
      target_type      = "ip"
    }
  ]
